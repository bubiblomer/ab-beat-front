                ...
                <div class="col-lg-12">
                    ...
                    <table class="table table-dark">
                        ...
                        <tr v-for="(item, index) in categories">
                            ...
                            <td data-label="Icon" v-html="item.icon"></td>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content darcula-bg">
                    <div class="modal-header">
                        <h5 class="modal-title">{{form.type}} Category </h5>
                    ...
                    <div class="modal-body text-left">
                        ...
                        <div class="form-group">
                            ...
                            <select v-model="form.icon" class="form-control">
                                <option v-for="lib in iconLibary" v-bind:value="lib.text" >
                                    {{lib.text}} <span v-html="lib.text"></span>
                                </option>
                            </select>


                            <span class="text-white fa-2x" v-html="form.icon "></span>

                            <span class="text-danger" v-if="errors.icon">{{errors.icon[0]}}</span>
                        </div>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'heeraexchange.in | Manage Category',
            }
        },
        data() {
            return {
                ...
                iconLibary: [
                    { text: '<i class="fal fa-futbol"></i>' },
                    { text: '<i class="fal fa-cricket"></i>'},
                    { text: '<i class="fal fa-tennis-ball"></i>'},
                    { text: '<i class="fal fa-hockey-puck"></i>'},
                    { text: '<i class="fal fa-volleyball-ball"></i>'},
                    { text: '<i class="fal fa-shuttlecock"></i>'},
                    { text: '<i class="fas fa-baseball-ball"></i>'},
                    { text: '<i class="fas fa-basketball-ball"></i>'},
                    { text: '<i class="fal fa-biking"></i>'},
                    { text: '<i class="fal fa-bowling-ball"></i>'},
                    { text: '<i class="fal fa-bowling-pins"></i>'},
                    { text: '<i class="fal fa-boxing-glove"></i>'},
                    { text: '<i class="fal fa-field-hockey"></i>'},
                    { text: '<i class="fal fa-golf-ball"></i>'}
                ],
                statuses: [
                    { text: 'Active', value: 1 },
        ...
        methods: {
            ...
            async submitCategoryForm(form){
                ...
                await this.$axios.$post('/categoryUpdate', form)
                    .then(res => {
