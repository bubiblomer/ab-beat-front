            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section-title mt-2 mb-30 justify-content-between media">
                        <h2 class="title">Manage Club</h2>
                       <div class="d-flex align-items-center">
                           <NuxtLink :to="{name: 'admin-club-add'}"  class="btn btn-info "><i class="fa fa-plus-circle"></i> Add Member</NuxtLink>

                           <form @submit.prevent="searchItem" class="ml-2">
                    ...
                    <table class="table table-dark">
                        ...
                        <tbody>
                        <tr v-for="(item, index) in adminClubs">
                            <th data-label="#">
                            ...
                            <td data-label="Action">
                                <NuxtLink :to="{name: 'admin-user-id', params:{id: item.id }}"
                                          type="button" class="btn btn-primary btn-round btn-sm">
                                    <i class="fa fa-eye"></i>
                                </NuxtLink>
...
<script>
    ...
    export default {
        ...
        head() {
            return {
                title: 'heeraexchange.in | Manage Club',
            }
        },
        data() {
            return {
        ...
        computed: {
            ...mapState(['basic', 'adminClubs', 'pageLinks', 'pageMeta']),
        },
        async asyncData({$axios, store, redirect}) {
            var _this = this;
            await $axios.get('/adminClubs')
                .then(res => {
                    store.dispatch("setAdminClubsData", res.data.data);
        ...
        methods: {
            async loadMore(key) {
                ...
                this.$store.dispatch('setAdminClubsData', res.data);
            ...
            async searchItem() {
                var _this = this;
                await this.$axios.$get('adminClubs?' + 'search=' + this.form.search, {
                    headers: {
                    ...
                    .then(res => {
                        console.log(res);
                        _this.$store.dispatch("setAdminClubsData", res.data);
